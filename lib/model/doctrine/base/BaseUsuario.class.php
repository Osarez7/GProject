 ...
 * @property integer $tipoUsuarioPK
 ...
 * @method integer             getTipoUsuarioPK() Returns the current record's "tipoUsuarioPK" value
 ...
 * @method Usuario             setTipoUsuarioPK() Sets the current record's "tipoUsuarioPK" value
...
abstract class BaseUsuario extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('tipoUsuarioPK', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
