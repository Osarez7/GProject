...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/sfprojects/gProject/log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/sfprojects/gProject/cache/backend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/sfprojects/gProject/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/sfprojects/gProject/cache/backend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/sfprojects/gProject/apps/backend/template',
)));
